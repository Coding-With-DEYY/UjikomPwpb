...
<article class="container-fluid pb-5 mb-5">
    <main class="mt-5 pt-3">
        <div class="border border-dark" style="margin-top: 25px; margin-left: 15%; margin-right: 15%;">
            <div style="margin-top: 25px; margin-left: 15%; margin-right: 15%;">
            <h1 style="text-align: center; text-decoration: underline;">Laman Edit Profile</h1>
            <form>
              ...
              <button style="margin-left: 570px;" type="submit" class="btn btn-success">Simpan</button>
            </form>
            <br>
        </div>
    </main>
